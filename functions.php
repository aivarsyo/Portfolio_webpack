...
function getStyle(){
    ...
    wp_enqueue_style('glide-js-style-core', get_stylesheet_uri('./node_modules/@glidejs/glide/src/assets/sass/glide.core'));
    wp_enqueue_style('glide-js-style-theme', get_stylesheet_uri('./node_modules/@glidejs/glide/src/assets/sass/glide.theme'));
